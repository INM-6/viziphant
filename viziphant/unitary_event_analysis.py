...
Figure = namedtuple("Figure", "ax0 ax1 ax2 ax3 ax4 ax5")
...
def plot_ue(data, Js_dict, sig_level, binsize, winsize, winstep,
    ...
    result : instance of NamedTuple
        The container for Axis objects generated by the function. Individual
        axes can be accessed using identifiers result.ax0 to result.ax5 for all
        6 axes, respectively.
    """
    ...
    result = Figure(ax0, ax1, ax2, ax3, ax4, ax5)
    return result
