...
print("Number of mip spike trains: " + str(len(sts_mip)))
...
num_neurons_mip = len(sts_mip)
num_ccs = (num_neurons_mip ** 2 - num_neurons_mip) / 2
...
all_combos_unit_i = []
all_combos_unit_j = []
for ni in range(num_neurons_mip):
    for nj in range(ni, num_neurons_mip):
